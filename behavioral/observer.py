...
class Client(Observer):
    ...
    def update(self, order_id: int) -> None:
        """принимаем номер текущего выполненного заказа и отписываемся от оповещения баристы"""
    ...
    def create_order(self) -> None:
        """Метод для формирования заказа и подписки на оповещения от баристы по выполненному заказу"""
